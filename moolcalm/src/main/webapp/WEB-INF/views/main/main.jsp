...
<h2 class="hide">메인화면 상품소개란입니다.</h2>
                <ul class="f_width_center">
                    <li>
                        <a href="">
                            <img src="../IMAGE/moolgam_image_unknown_sunshine001.png" alt="햇살과 숲">
                        </a>
                    </li>
                </ul>
            </figure><!--.F_main_image-->
...
<h2 class="hide">메뉴입니다.</h2>
            <nav class="m_nav">
                <ul>
                    <li><a href="javascript:void(0);" onclick="window.open('/member/login.jsp', 'login', 'top=200, left=500, width=500, height=550, status=no, menubar=no, toolbar=no, resizable=no');">
                        로그인</a></li>
                    <li><a href="/member/member_info.jsp">
                        mine
                    </a></li>
                    <li><a href=""></a></li>
                </ul>
